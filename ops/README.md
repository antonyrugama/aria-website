...
a second bold span later in the same bullet is body text, a blind spot written into a bullet's
body is not a line, and a bullet with no bold opener is reported as one rather than skipped.
A section written as prose says so on its guard's line; it is not read.
